...
public class TesterPercolation {
	...
	*/
	public TesterPercolation ( int n ){
		gridSize 	  = n;
		gridSquared   = gridSize * gridSize;
		wquFind       = new MyWQU(gridSquared + 2);
	...
	*/
	public static void main ( String[] args ) {
        ...
        double p = 0.593;
        TesterPercolation pl = new TesterPercolation(5);
