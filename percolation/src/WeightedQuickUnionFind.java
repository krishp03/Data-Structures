...
public class WeightedQuickUnionFind {
    ...
    public int[] parent;   // used by weighted union-find, see quick-union slides
	public int[] size;     // used by weighted union-find. 
	...
	*/
	...
	public static void main(String[] args) {
		WeightedQuickUnionFind qu = new WeightedQuickUnionFind(10);
        qu.union(1, 2);
        qu.union(4, 5);
        qu.union(6, 7);
        qu.union(0, 1);
        qu.union(2, 4);
        for(int val: qu.parent){
